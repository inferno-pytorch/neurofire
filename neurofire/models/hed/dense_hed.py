...
from .hed2 import DefaultHEDBlock, DefaultHEDBlock3D


# TODO implement dense block
class DenseHEDBlock(nn.Module):
    pass
...
class DenseHED(nn.Module):
    ...
    def __init__(self,
        ...
        self.conv4 = self.block_types[self.block_type_key[4]](13*N, 14*N)
        ...
        self.upsample0 = sample_type0[1](self.scale_factor[0])
        self.upsample1 = sample_type1[1](self.scale_factor[1])
        self.upsample2 = sample_type2[1](self.scale_factor[2])
        self.upsample3 = sample_type3[1](self.scale_factor[3])
    ...
    def forward(self, x):
        ...
        # make fusion output
        out5 = self.dsn6(torch.cat((out0, out1, out2, out3, out4), 1))
